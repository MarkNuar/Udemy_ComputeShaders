        ...
        get
        {
            ...
            else // create a blade mesh
            {
                ...
                Vector3[] vertices =
                {
                    ...
                    new Vector3( halfWidth, rowHeight, 0),
                    new Vector3(-halfWidth*0.9f, rowHeight*2, 0), // shrink on the x, blade shrinking going up
                ...
                Vector2[] uvs =
                {
                    new Vector2(0,0),
                    new Vector2(1,0),
                    new Vector2(0,0.25f), // we moved up a quarter of the texture 
                    new Vector2(1,0.25f),
                    new Vector2(0,0.5f),
                    new Vector2(1,0.5f),
                    new Vector2(0,0.75f),
                ...
                //4. Define the indices array, anticlockwise! 
                int[] indices =
                {
                    0,1,2,1,3,2,//row 1
                    2,3,4,3,5,4,//row 2
